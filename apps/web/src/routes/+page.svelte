...
<section class="max-w-6xl mx-auto px-4 pt-24 pb-20">
  <div class="soft-panel rounded-3xl p-8 sm:p-12 relative overflow-hidden">
    <div class="absolute -top-24 -right-24 w-72 h-72 rounded-full bg-sky-300/10 blur-3xl"></div>
    <div class="absolute -bottom-24 -left-24 w-72 h-72 rounded-full bg-amber-300/10 blur-3xl"></div>
    ...
    <div class="relative z-10 max-w-3xl" in:fly={{ y: 22, duration: 500 }}>
      ...
      <div class="flex flex-wrap gap-3">
        {#if $currentUser}
          ...
          <a href="/battle" class="soft-panel rounded-xl px-6 py-3 font-semibold hover:bg-white/10 transition-colors">Enter Battle</a>
        {:else}
          ...
          <a href="/collection" class="soft-panel rounded-xl px-6 py-3 font-semibold hover:bg-white/10 transition-colors">Browse Collection</a>
        {/if}
      </div>
    </div>
  </div>
...
<section class="max-w-6xl mx-auto px-4 py-10">
  <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
    {#each features as feature, i}
      <div class="soft-panel rounded-2xl p-6" in:fly={{ y: 18, duration: 450, delay: i * 90 }}>
        <div class="w-10 h-10 rounded-lg bg-sky-300/15 border border-sky-300/20 flex items-center justify-center text-sky-200 mb-4">
